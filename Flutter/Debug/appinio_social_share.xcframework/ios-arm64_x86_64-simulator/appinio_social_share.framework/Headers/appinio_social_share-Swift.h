...
#ifndef APPINIO_SOCIAL_SHARE_SWIFT_H
#define APPINIO_SOCIAL_SHARE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="appinio_social_share",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC20appinio_social_share29SwiftAppinioSocialSharePlugin")
@interface SwiftAppinioSocialSharePlugin : NSObject <FBSDKSharingDelegate, FlutterPlugin>
