...
class FinanceAddPage extends StatefulWidget {
  const FinanceAddPage({Key? key}) : super(key: key);

  @override
  State<FinanceAddPage> createState() => _NewsAddPageState();
}

class _NewsAddPageState extends AppState<FinanceAddPage, FinanceController> {
