...
import 'package:eu_faco_parte/app/models/item_model.dart';
...
class JobsDetailPage extends StatefulWidget {
  const JobsDetailPage({Key? key}) : super(key: key);

  @override
  State<JobsDetailPage> createState() => _JobsDetailPageState();
}

class _JobsDetailPageState extends AppState<JobsDetailPage, JobsController> {
  @override
