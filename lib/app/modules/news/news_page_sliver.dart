...
import '../../core/ui/widgets/appbar_wave/sliver_search_app_bar.dart';
                ...
                child: GestureDetector(
                  onTap: () {
                    Get.toNamed('/news_detail', parameters: {
                      'idNews': controller.newsList[index].idNews.toString(),
                      'date': controller.newsList[index].date.toString(),
                      'title': controller.newsList[index].title.toString(),
                      'url_image':
