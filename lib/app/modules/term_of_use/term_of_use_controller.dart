...
class TermOfUseController extends GetxController
  ...
  TermOfUseRepository repository;
  AuthRepository authRepository;
  final _loading = false.obs;
  final _message = Rxn<MessageModel>();
  final _dialog = Rxn<DialogModel>();
  var termList = <TermModel>[].obs;
  Rx<List<TermModel>> foundAbout = Rx<List<TermModel>>([]);
  ...
  void subscribe() {
    ...
    subscription = realtime.subscribe([
      'databases.${constants.DATABASE_ID}.collections.${constants.COLLETION_TERM_OF_USE}.documents'
    ]);
  ...
  Future<void> termOfUseAdd(Map map) async {
    try {
      _loading.toggle();

      await repository.termoOfUseAddRepository(map);
      ...
      _message(
        MessageModel(
          title: 'Parabéns!',
          message: 'Termo de uso adicionado com sucesso!',
          type: MessageType.success,
        ),
      );
    } catch (e) {
  ...
  Future termOfUseDelete(String idabout) async {
    try {
      Get.back();
      _loading.toggle();

      await repository.termoOfUseDeleteRepository(idabout);
      ...
      Get.snackbar(
        'Parabéns!',
        'Termo de uso excluído com sucesso!',
  ...
  Future<void> termOfUseUpdate(Map map) async {
    try {
      _loading.toggle();

      await repository.termOfUseUpdateRepository(map);
      ...
      _message(
        MessageModel(
          title: 'Parabéns!',
          message: 'Termo de uso atualizado com sucesso!',
          type: MessageType.success,
        ),
      );
    } catch (e) {
