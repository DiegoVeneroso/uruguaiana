...
class JobsAddPage extends StatefulWidget {
  const JobsAddPage({Key? key}) : super(key: key);

  @override
  State<JobsAddPage> createState() => _NewsAddPageState();
}

class _NewsAddPageState extends AppState<JobsAddPage, JobsController> {
  ...
  final _functionEC = TextEditingController();
              ...
              child: Column(
                ...
                children: [
                  ...
                  CustomTextformfield(
                    label: 'Função',
                    controller: _phoneEC,
                    validator: Validatorless.required('Função é obrigatório'),
                    maxlines: 1,
                  ),
                  const SizedBox(
                    height: 10,
                  ...
                  CustomTextformfield(
                    ...
                    controller: _initActivityEC,
                    validator:
                        Validatorless.required('Chave pix é obrigatório'),
                    maxlines: 1,
                    dateMask: true,
                  ),
                  const SizedBox(
