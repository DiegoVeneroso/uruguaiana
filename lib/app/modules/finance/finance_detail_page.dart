...
class FinanceDetailPage extends StatefulWidget {
  const FinanceDetailPage({Key? key}) : super(key: key);

  @override
  State<FinanceDetailPage> createState() => _NewsDetailPageState();
}

class _NewsDetailPageState extends AppState<FinanceDetailPage, NewsController> {
  @override
