...
class FinanceEditPage extends StatefulWidget {
  const FinanceEditPage({Key? key}) : super(key: key);

  @override
  State<FinanceEditPage> createState() => _NewsEditPageState();
}

class _NewsEditPageState extends AppState<FinanceEditPage, NewsController> {
  @override
